#!/usr/bin/env bash
# Create the CertA client in the OAuth2 IdP via Admin API.
# Usage: OAUTH2_IDP_BASE_URL=https://auth.dev.net/auth OAUTH2_IDP_REALM=master OAUTH2_IDP_ADMIN_USER=admin OAUTH2_IDP_ADMIN_PASSWORD=admin ./create-oauth2-client.sh
# Or run with defaults: OAUTH2_IDP_ADMIN_USER=admin OAUTH2_IDP_ADMIN_PASSWORD=admin ./create-oauth2-client.sh
